...
Using TypeScript and React, your challenge is to build out a URL shortening web app, integrate with the [Clean URI API](https://cleanuri.com/docs), and get it looking as close to the design as possible.
